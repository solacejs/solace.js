...
class Guild {
    ...
    constructor(data) {
        ...
        this.emojis = data.emojis.map((emoji) => new Emoji_1.Emoji(emoji));
        ...
        this.roles = data.roles.map((role) => new Role_1.Role(role));
        this.rulesChannelId = data.rules_channel_id;
        this.safetyAlertsChannelId = data.safety_alerts_channel_id;
        this.splash = data.splash;
        this.stickers = data.stickers ? (_l = data.stickers) === null || _l === void 0 ? void 0 : _l.map((sticker) => new Sticker_1.Sticker(sticker)) : [];
        this.systemChannelFlags = data.system_channel_flags;
        this.systemChannelId = data.system_channel_id;
        this.vanityUrlCode = data.vanity_url_code;
        this.verificationLevel = data.verification_level;
        this.welcomeScreen = data.welcome_screen ? new WelcomeScreen_1.WelcomeScreen(data.welcome_screen) : null;
